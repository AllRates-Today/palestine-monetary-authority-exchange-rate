# Palestine Monetary Authority Exchange Rate API — palestine-monetary-authority-exchange-rate
...
Also published under the org scope as [`@allratestoday/palestine-monetary-authority-exchange-rate`](https://www.npmjs.com/package/@allratestoday/palestine-monetary-authority-exchange-rate) — same code, same versions.
...
```javascript
{
  ...
  rate_date: '2026-08-20',   // Palestine Monetary Authority's own publication date
  source: 'USD',
  target: 'ILS',
  rate: 2.9799,
  rate_type: 'sell',
...
```javascript
{
  ...
  rates: [
    { "base": "USD", "quote": "ILS", "type": "sell", "value": 2.9799 },
    { "base": "USD", "quote": "ILS", "type": "buy", "value": 2.977 },
...
const series = await getHistory(
  { source: 'USD', target: 'ILS', from: '2026-01-01', to: '2026-08-20' },
  { apiKey: 'art_live_...' }
);
```
...
```javascript
{
  ...
  rates: [
    ...
    { date: '2026-08-20', rate: 2.9799, rate_type: 'sell', derived: false, method: 'published' },
    // …
  ],
  disclaimer: '…'
}
